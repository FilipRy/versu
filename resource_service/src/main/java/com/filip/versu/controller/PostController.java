...
public class PostController extends AbsAuthController<Long, Post, PostDTO> {
    ...
    public PostDTO create(@RequestBody PostDTO shoppingItem, @RequestHeader(AUTHORIZATION_HEADER) String accessToken) {
    ...
    public PostDTO getDetails(@PathVariable("id") Long shoppingItemID, @RequestHeader(AUTHORIZATION_HEADER) String accessToken) {
        User requester = authenticateUser(accessToken);
        Post post = postService.getDetails(shoppingItemID, requester);
    ...
    public PostDTO getDetailsBySecretUrlAuth(@PathVariable("hexId") String secretUrl, @RequestHeader(AUTHORIZATION_HEADER) String accessToken) {
    ...
    public List<String[]> findVSPossibilities(@PathVariable("pattern") String pattern, @RequestHeader(AUTHORIZATION_HEADER) String accessToken) {
        User requester = authenticateUser(accessToken);
    ...
    public List<UserDTO> listViewersOfShoppingItem(@PathVariable("id") Long shoppingItemID, @RequestHeader(AUTHORIZATION_HEADER) String accessToken) {
        User requester = authenticateUser(accessToken);
    ...
    public PostDTO update(@RequestBody PostDTO shoppingItem, @RequestHeader(AUTHORIZATION_HEADER) String accessToken) {
        User requester = authenticateUser(accessToken);
    ...
    public PostDTO delete(@PathVariable("id") Long id, @RequestHeader(AUTHORIZATION_HEADER) String accessToken) {
        User requester = authenticateUser(accessToken);
    ...
    public URLWrapperDTO getGeneratedPreSignedURL(@RequestBody URLWrapperDTO urlWrapperDTO, @RequestHeader(AUTHORIZATION_HEADER) String accessToken) {
        User requester = authenticateUser(accessToken);
