...
app.factory('VotersPagingFact', ['$http', 'authFact', 'BACKEND_URL', function ($http, authFact, BACKEND_URL) {
    ...
    VotersPagingFact.prototype.nextPage = function () {
        ...
        var url = BACKEND_URL + "/api/postfeedback/findByPostAndName/" + this.secretUrl + "/" + this.voteName + "?page=" + this.pageNr + "&limit=" + this.pageSize;
