...
angular.module('myApp.post_detail', ['ngRoute'])
    ...
    .controller('postDetailCtrl', ['$scope', '$routeParams', '$http', 'authFact', 'VotersPagingFact', '$cookieStore',
        ...
        function ($scope, $routeParams, $http, authFact, VotersPagingFact, $cookieStore,
            ...
            //This variable is used in the goto app dialog
            var gotoAppDialogContent = {};
            ...
            $scope.displayRedirectionToApp = function (type, content) {
                displayRedirectionToApp(type, content);
            };
            ...
            function logout() {
                ...
                displayToast('You have been loged out!', 3000);
            ...
            function displayRedirectionToApp(type, content) {
                var message = '';
                if (type == 'user') {
                    message = 'Let\'s go to the app to see other dilemmas by ' + content + " !";
                } else if (type == 'hashtag') {
                    message = 'Let\'s go to the app to see similar dilemmas marked with ' + content + " !";
                } else if (type == 'location') {
                    message = 'Let\'s go to the app to see other dilemmas from ' + content + " !";
                }
                else {
                    message = 'Let\'s go to the app to enjoy all features!';
                }

                gotoAppDialogContent = message;

                $mdDialog.show({
                    controller: GotoAppController,
                    templateUrl: 'gotoappdialog.tmpl.html',
                    parent: angular.element(document.body),
                    clickOutsideToClose: false,
                    fullscreen: $scope.customFullscreen, // Only for -xs, -sm breakpoints.
                    skipHide: true
            ...
            function GotoAppController($scope, $mdDialog) {

                $scope.content = gotoAppDialogContent;
                $scope.versuUrl = 'https://versu.co/';
