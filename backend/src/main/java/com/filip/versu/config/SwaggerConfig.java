...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.filip.versu.controller"))
    ...
    public SecurityConfiguration security() {
        return new SecurityConfiguration
                (this.clientId, this.clientSecret, "", "", "Bearer access token", ApiKeyVehicle.HEADER, HttpHeaders.AUTHORIZATION,"");
    }


    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Versu Backend API").description("")
